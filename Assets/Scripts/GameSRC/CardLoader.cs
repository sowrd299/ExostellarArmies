...
namespace SFB.Game.Content {
    ...
    public class CardLoader : IdIssuer<Card>{ // maybe this doesn't want to be an IdIssuerr... sure feels like it does though
        ...
        CardLoader()
        {
            ...
            m_listofCards.Add("Screaming Spore Spunner", new UnitCard(1, "Screaming Spore Spunner", Faction.MYXOR, "Spore 1 (when this dies, gain 1 resource)", "Muxi ji maRtox raj!",
            ...
            m_listofCards.Add("Aftergrowth Spunner", new UnitCard(2, "Aftergrowth Spunner", Faction.MYXOR, "Spore  3 (when this dies, gain 3 resources)", "toxhMar IOz Yzhmat rho!",
            ...
            m_listofCards.Add("Spore Pod", new UnitCard(1, "Spore Pod", Faction.MYXOR, "Spore 1 (when this dies, gain 1 resource)\nDeath:Beta Swarm (if there is nothing in this back row, reveal the top card of your deck and play it at -1 Cost. If you can't, put it in your graveyard)",
               "Myxi jha maRtox IOz", 0, 0, 1, new AbilityList(new Ability[] { new Spore(1) })));
            m_listofCards.Add("Horde Caller", new UnitCard(3, "Horde Caller", Faction.MYXOR, "Spore 2 (when this dies, gain 3 resources)\nDeath: +1 Extra deploy", "MuxhRaz izt zraZxh",
                    0, 3, 2, new AbilityList(new Ability[] { new Spore(2) })));
            m_listofCards.Add("Titanous Regrowth Trunk", new UnitCard(6, "Titanous Regrowth Trunk", Faction.MYXOR, "Persistent: Other allies gain Spore +1(when this dies, gain 1 resource)\n" +
            ...
            m_listofCards.Add("Adv. Supply Drone", new UnitCard(2, "Adv. Supply Drone", Faction.CARTH, "Supporting Carthan Deploy: Heal the supported unit 2 and gain 3 resources.",
